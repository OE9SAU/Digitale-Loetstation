 ...
 * Foundation, Inc., 51 Franklin Street, Fifth Floor, Boston, MA  02110-1301, USA.
   ...
   Version       1.3 vom 19.10.2024 / OE9SAU
                 ...
                 *STEP 346: 4000 auf 2500ms 
                 1.5 vom 15.04.2025
                 *flackerLogoLED ohne delay
                 *NOTAUSDIFF von 50 auf 30
                 *NOTAUSANZ von 10 auf 5
*/
...
#define NOTAUSDIFF   30                               // Abweichung vom letzten (sinnvollen) Wert, ab welcher ein Wert als ungueltig betrachtet wird
#define NOTAUSANZ    5                                // Anzahl der direkt aufeinanderfolgenden, ungueltigen Werte, bevor NOTAUS erfolgt
...
unsigned long letzteFlackerZeit = 0;
int flackerDelay = 0;
...
void loop(){
  ...
  flackerLogoLED();                                   // LOGO-FLACKER-LED
}
...
void flackerLogoLED() {
  if (pwm > 10) {
    ...
    if (aktuelleZeit - letzteFlackerZeit >= flackerDelay) {
      letzteFlackerZeit = aktuelleZeit;
      flackerDelay = random(100, 400);
      analogWrite(8, random(100, 256));
    }
  }
}
